...
namespace FTN.Common
{
	public class EnumDescs
	{
		...
		public EnumDescs()
		{
			property2enumType.Add(ModelCode.REGCTRL_MODE, typeof(RegulatingControlModeKind));
			property2enumType.Add(ModelCode.REGCTRL_MONITOREDPH, typeof(PhaseCode));
			property2enumType.Add(ModelCode.BIS_V1U, typeof(UnitSymbol));														
		}

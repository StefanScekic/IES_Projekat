...
{	
	...
	public class ModelResourcesDesc
	{
		...
		{			
			...
			typeIdsInInsertOrder.Add(ModelCode.DT);
		...
		{			
            ...
            notSettablePropertyIds.Add(ModelCode.RIS_TP);
            notSettablePropertyIds.Add(ModelCode.DT_SEASONDTSCH);
            notSettablePropertyIds.Add(ModelCode.SEASON_SEASONDTSCH);
            notSettablePropertyIds.Add(ModelCode.REGCTRL_REGSCH);
			notSettablePropertyIds.Add(ModelCode.SWITCH_SWSCH);
        }

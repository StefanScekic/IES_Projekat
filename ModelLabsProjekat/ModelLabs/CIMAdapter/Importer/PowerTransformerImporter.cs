...
namespace FTN.ESI.SIMES.CIM.CIMAdapter.Importer
{
	...
	public class PowerTransformerImporter
	{
        ...
        private object cimRegulationSchedulePair;
		...
		private ResourceDescription CreateDayTypeResourceDescription(FTN.DayType cimDayType)
		{
			...
			if (cimDayType != null)
			{
				long gid = ModelCodeHelper.CreateGlobalId(0, (short)DMSType.DT, importHelper.CheckOutIndexForDMSType(DMSType.DT));
				rd = new ResourceDescription(gid);
		...
		private ResourceDescription CreateRegulatingControlResourceDescription(FTN.RegulatingControl cimRegulatingControl)
		{
			...
			{
				long gid = ModelCodeHelper.CreateGlobalId(0, (short)DMSType.REGCTRL, importHelper.CheckOutIndexForDMSType(DMSType.REGCTRL));
				rd = new ResourceDescription(gid);
        ...
        private ResourceDescription CreateSwitchScheduleResourceDescription(FTN.SwitchSchedule cimSwitchSchedule)
        {
            ...
            {
                long gid = ModelCodeHelper.CreateGlobalId(0, (short)DMSType.SWITCHSCH, importHelper.CheckOutIndexForDMSType(DMSType.SWITCHSCH));
                rd = new ResourceDescription(gid);

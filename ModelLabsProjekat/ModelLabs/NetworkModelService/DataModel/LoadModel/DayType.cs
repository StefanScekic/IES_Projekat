...
namespace FTN.Services.NetworkModelService.DataModel.LoadModel
{
    public class DayType : IdentifiedObject
    {
        ...
        {
            return obj is DayType type &&
                   base.Equals(obj) &&
                   CompareHelper.CompareLists(type.seasonDayTypeSchedules, seasonDayTypeSchedules);
        }
        ...
        {   
            ...
            {
                references[ModelCode.DT_SEASONDTSCH] = seasonDayTypeSchedules.GetRange(0, seasonDayTypeSchedules.Count);
            }
